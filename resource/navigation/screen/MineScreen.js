...
import {NavigationItem,color,SpacingView,DetailCell} from '../widget';
    ...
    static navigationOptions = ({ navigation }) => ({
        headerRight:(
            <View style={{flexDirection:'row'}}>
                ...
                />
                <NavigationItem
                    icon={require('../../../img/Mine/icon_navigationItem_message_white@2x.png')}
                    onPress={()=>{
                        alert('Syntax');
                    }}
                />
        ...
        return (
            <View style={styles.header}>
                <View style={styles.userContainer}>
                    ...
                    <View>
                        <View style={{flexDirection:'row'}}>
                            <Heading1 style={{color:'white'}}>泽阳</Heading1>
                            <Image
                                style={{marginLeft:4}}
        ...
        return (
            [
                ...
                [
                    ...
                    { title: '关于', subtitle: '我要合作', image: require('../../../img/Mine/icon_mine_aboutmeituan@2x.png') }
                ]
            ]
        )
    }
